...
const SECONDARY_NAV = [
  ...
  { to: "/livre/reports/pro", label: "Rapports professionnels", icon: FileText, testId: TEST_IDS.layout.navReportsPro },
  { to: "/livre/reports/perso", label: "Rapports personnels", icon: FileText, testId: TEST_IDS.layout.navReportsPerso },
    ...
    <div className="min-h-screen flex bg-[#F4F6F8] font-[IBM_Plex_Sans,sans-serif]">
      ...
      <aside data-testid={TEST_IDS.layout.sidebarSecondary} className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0">
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
          <p className="px-3 text-[10px] uppercase tracking-[0.15em] text-slate-400 mb-2">Reports / Livre de bord</p>
